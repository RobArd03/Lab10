...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._dbState = ft.Dropdown(label="Seleziona stato", disabled = True)
        self._btnRicerca = ft.ElevatedButton(text="Ricerca", on_click=self._controller.handleRicerca, disabled = True)
        row2 = ft.Row([self._dbState, self._btnRicerca], alignment=ft.MainAxisAlignment.CENTER)
